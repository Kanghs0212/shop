...
public class ItemService {
    ...
    public void saveItem(String title, Integer price, String text, String imgURL, String category, Authentication auth){
        var item = new Item();
    ...
    public Page<Item> findPageByCategory(String category, Integer pageNum){
        Page<Item> result = itemRepository.findByCategory(category, PageRequest.of(pageNum-1, 10));
        return result;
    }
