...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (itemRepository.count() == 0) {
            String[][] items = {
                {"트렌디 체크셔츠", "39000", "깔끔한 체크 패턴의 셔츠입니다.", "/images/checkshirt.jpg"},
                {"클래식 면바지", "49000", "편안한 착용감의 코튼 진입니다.", "/images/cottonjean.jpg"},
                {"캐주얼 후드티", "35000", "따뜻하고 편안한 후드티입니다.", "/images/hood.jpg"},
                {"슬림핏 청바지", "45000", "슬림한 핏의 청바지입니다.", "/images/jean.jpg"},
                {"조거 진", "42000", "활동적인 스타일의 조거 진입니다.", "/images/joggerjean.jpg"},
                {"베이직 셔츠", "32000", "깔끔한 기본 셔츠입니다.", "/images/shirt.jpg"},
                {"니트 스웨터", "55000", "따뜻한 니트 스웨터입니다.", "/images/sweater.jpg"},
                {"라운드 티셔츠", "25000", "기본 라운드넥 티셔츠입니다.", "/images/tshirt.jpg"},
                {"오버핏 후드집업", "48000", "오버핏 후드집업입니다.", "/images/hood.jpg"},
                {"와이드 팬츠", "38000", "편안한 와이드 핏 팬츠입니다.", "/images/cottonjean.jpg"},
                {"스트라이프 셔츠", "36000", "세련된 스트라이프 패턴 셔츠입니다.", "/images/shirt.jpg"},
                {"데님 자켓", "65000", "클래식한 데님 자켓입니다.", "/images/jean.jpg"},
            };
